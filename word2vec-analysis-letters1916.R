################################################################################
# File-Name: word2vec-analysis-letters1916.R                                   #
# Date: 27 October 2016                                                        #
# Author: Sara J Kerr                                                          # 
# ORCID:orcid.org/0000-0002-2322-1178                                          #
# Institution: Maynooth University                                             #
# Project: Letters of 1916 - Prof Susan Schreibman                             #
# Purpose: script for word2vec analysis based on nearest_to                    #
...
#           https://github.com/SaraJKerr/Pilot_Study/blob/master/Code/         #
#              word2vec_analysis.R                                             #
...
w2v_analysis_letters1916 <- function(vsm, word, seed, path, ref_name) {
        # Set the seed
        if (!missing(seed))
                set.seed(seed)
        
        # Identify the nearest 10 words to the average vector of search terms
        ten <- nearest_to(vsm, vsm[[word]])
        ...
        reduction <- Rtsne(as.matrix(new_model), dims = 2, initial_dims = 100, 
